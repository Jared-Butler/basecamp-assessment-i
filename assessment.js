...
var notHakeem = (myName.length == "Hakeem Olajuwon".length);
console.log(notHakeem);

var notHakeem = (myName.length == "Karl Malone".length);
console.log(notHakeem);
...
var responseCreator = function(param){
 if (param == "green"){console.log("Green is okay")}
 else if (param == "red"){console.log("I heart red")}
...
var name = "Jared Butler";
var number = 24

function greeter(name,number){
  console.log("Hi, my name is "+name+" and I am "+number+" years old!")
};
greeter(name, number)